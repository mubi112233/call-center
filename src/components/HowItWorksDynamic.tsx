              ...
              >
                <div className={`flex flex-col md:flex-row gap-6 sm:gap-8 md:gap-10 items-center ${index % 2 === 1 ? 'md:flex-row-reverse' : ''}`}>
                  ...
                  >
                    ...
                    <IconComponent className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 text-foreground relative z-10" />
                  ...
                  <motion.div 
                    className={`flex-1 bg-card rounded-xl sm:rounded-2xl p-6 sm:p-8 md:p-10 hover:shadow-gold-lg transition-all duration-500 group ${index % 2 === 1 ? 'md:text-right' : ''}`}

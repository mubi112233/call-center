      ...
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="max-w-6xl mx-auto">
          {steps.map((step, index) => (
            ...
            >
              <div className="flex-shrink-0 w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 rounded-full bg-gradient-to-br from-gold via-primary to-gold flex items-center justify-center shadow-elegant relative group">
              ...
              <div className="flex-1 bg-card rounded-xl sm:rounded-2xl p-6 sm:p-8 md:p-10 hover:shadow-gold-lg transition-all duration-500 group">
                ...
                <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-2 sm:mb-4 text-foreground group-hover:text-gold transition-colors duration-300">
